...
<head>
	<meta charset="UTF-8">
	<title><?php echo ($_ENV['site_info']['seo_title']); ?>|<?php echo ($artdata[0]['title']); ?></title>
	<meta name="description" content="<?php echo ($artdata[0]['seo_description']); ?>">
	<meta name="keyword" content="<?php echo ($artdata[0]['seo_key']); ?>">
		...
		<div class="rightWrap">
			<div class="lead">
				...
				<p class="left">
					...
					><a href="<?php echo U('Home/Mediafocus/mediafocus');?>">媒体聚焦</a>
					><?php echo ($artdata[0]['title']); ?></p>
			</div>
			<p class="essayTitle">
				<?php echo ($artdata[0]['title']); ?>
			</p>
			<p class="essayMessage">
				<span>作者：<?php echo ($artdata[0]['author']); ?></span>
				<span>时间：<?php echo date("Y-m-d",$artdata[0]['update_time']);?></span>
				<span>浏览：<?php echo ($readtimes); ?></span>	
			</p>
			<div class="text">
				<?php echo stripslashes($artdata[0]['content']);?>
			</div>
			<div class="bottom">
				...
				<p>
					<span><?php if ($predata[0]['id']!=null): ?>上一篇：<?php endif ?> </span><a href="<?php echo U('Home/Mcategory/mcategory/id/'.$predata[0]['id']);?>"><span><?php echo ($predata[0]['title']); ?></span></a>
					<a href="<?php echo U('Home/Mcategory/mcategory/id/'.$nextdata[0]['id']);?>"><span class="right"><?php echo ($nextdata[0]['title']); ?></span></a><span class="right"><?php if ($nextdata[0]['id']!=null): ?>下一篇：<?php endif ?> 
					</span>
				</p>
			</div>
		</div>
