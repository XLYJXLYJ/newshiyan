...
<html lang="en">
	<head>
		...
		<!-- <link rel="stylesheet" href="/oyes2/Application/Admin/View/Public/css/bootstrap.min.css" />
		<link rel="stylesheet" href="/oyes2/Application/Admin/View/Public/css/bootstrap-responsive.min.css" />
		<link rel="stylesheet" href="/oyes2/Application/Admin/View/Public/css/uniform.css" />
		<link rel="stylesheet" href="/oyes2/Application/Admin/View/Public/css/select2.css" />
		<link rel="stylesheet" href="/oyes2/Application/Admin/View/Public/css/unicorn.main.css" />
		<link rel="stylesheet" href="/oyes2/Application/Admin/View/Public/css/unicorn.grey.css" class="skin-color" />
 -->
		<link rel="stylesheet" href="/oyes2/Application/Admin/View/Public/css/bootstrap.min.css" />
		<link rel="stylesheet" href="/oyes2/Application/Admin/View/Public/css/bootstrap-responsive.min.css" />
		<link rel="stylesheet" href="/oyes2/Application/Admin/View/Public/css/jquery.gritter.css" />
		<link rel="stylesheet" href="/oyes2/Application/Admin/View/Public/css/uniform.css" />
		<link rel="stylesheet" href="/oyes2/Application/Admin/View/Public/css/select2.css" />
		<link rel="stylesheet" href="/oyes2/Application/Admin/View/Public/css/unicorn.main.css" />
		<link rel="stylesheet" href="/oyes2/Application/Admin/View/Public/css/unicorn.grey.css" class="skin-color" />
		<link rel="stylesheet" href="/oyes2/Application/Admin/View/Public/css/add_manger.css" />
	...
	<body>
		...
		<div id="content">
						...
						<div class="widget-box">
							<div class="widget-title">
								...
								<div style="float:right;margin-right:50px">
									<a href="#addFatherType" data-toggle="modal"><span class="label">添加分类</span></a>
								</div>
								<!-- 添加一级分类弹出框 -->
								...
								<table class="table table-bordered table-striped">
									...
									<tbody>
										...
										<?php if(is_array($list)): foreach($list as $key=>$type): ?><!-- 子类循环 -->
											...
											<td>
												<?php if($type["depth"] > 1): $__FOR_START_5117__=1;$__FOR_END_5117__=$type["depth"];for($i=$__FOR_START_5117__;$i < $__FOR_END_5117__;$i+=1){ ?>┣<?php } endif; ?>
												<input type="text" name="<?php echo ($type["id"]); ?>" value="<?php echo ($type["sorted"]); ?>" style="width:20px" />
											</td>
											<td>
											<?php if($type["depth"] > 1): $__FOR_START_18674__=1;$__FOR_END_18674__=$type["depth"];for($i=$__FOR_START_18674__;$i < $__FOR_END_18674__;$i+=1){ ?>┣<?php } endif; ?>
											...
											<td>
											<!-- 操作按钮 -->
											<a href="#editMess<?php echo ($type["id"]); ?>" data-toggle="modal"  class="btn btn-success"><i class="icon-wrench">
											</i>编辑</a>
											<!--设置分类是否可见的按钮-->
											<?php if($type["status"] == 0): if($type["url"] != null): ?><a href="<?php echo U('Category/setStatus','id='.$type['id'],'');?>" class="btn btn-primary"><i class="icon-eye-open icon-white"></i>显示</a>
													<?php else: ?>
											...
											<a href="#deleteAlert<?php echo ($type["id"]); ?>" data-toggle="modal" class="btn btn-danger"><i class="icon-remove icon-white"></i>删除</a>
											<?php if($type["depth"] == 1): ?><a href="#addChildType<?php echo ($type["id"]); ?>" data-toggle="modal"  class="btn btn-success" ><i class="icon-plus icon-white"></i>添加子页面</a><?php endif; ?>
  											...
  											<!--横幅预览-->
												...
												<!-- 删除弹出框-->
													...
													<div id="alertStatus<?php echo ($type["id"]); ?>" class="modal hide">
														...
														<div class="modal-body">
															<p><?php echo ($type["name"]); ?>链接为空，请先修改内容</p>
														</div>
														<div class="modal-footer">
													...
													<div id="editMess<?php echo ($type["id"]); ?>" class="modal hide">
														<div class="modal-header">
															<button data-dismiss="modal" class="close" type="button">×</button>
															<h3>修改<?php echo ($type["name"]); ?>的子页面</h3>
														</div>
									            		<div class="modal-body">
															<div class="control-group">
																<form class="form-horizontal" method="post" action="<?php echo U('Category/editNav','','');?>"/>
                                    								<div class="control-group">
                                        								<label class="control-label">名称</label>
                                        								<div class="controls">
                                    								...
                                    								<div class="control-group">
                                        								...
                                        								<div class="controls">
                                            								<input type="text" name="url"  value="<?php echo ($type["url"]); ?>" />
           ...
           <script src="/oyes2/Application/Admin/View/Public/js/jquery.min.js"></script>
            <script src="/oyes2/Application/Admin/View/Public/js/jquery.ui.custom.js"></script>
            <script src="/oyes2/Application/Admin/View/Public/js/bootstrap.min.js"></script>
            <script src="/oyes2/Application/Admin/View/Public/js/jquery.uniform.js"></script>
            <script src="/oyes2/Application/Admin/View/Public/js/select2.min.js"></script>
            <script src="/oyes2/Application/Admin/View/Public/js/jquery.validate.js"></script>
            <script src="/oyes2/Application/Admin/View/Public/js/jquery.wizard.js"></script>
            <script src="/oyes2/Application/Admin/View/Public/js/unicorn.js"></script>
            <script src="/oyes2/Application/Admin/View/Public/js/unicorn.wizard.js"></script>
            <script src="/oyes2/Application/Admin/View/Public/js/unicorn.form_validation.js"></script>
