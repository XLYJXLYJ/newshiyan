    ...
    <body>
        ...
        <div id="sidebar">
            ...
            <ul>
                ...
                <!--<li class="active">
                    <a href="<?php echo U('Category/cate_list','','');?>"><i class="icon-align-justify"></i> <span>底部设置</span></a>
                </li>-->
                <!--<li class="submenu active open"><a href="#"><i class="icon-align-justify"></i> <span>底部设置</span><span class="label">2</span></a>
                    <ul>
                        <li ><a href="<?php echo U('Footer/index','','');?>">底部超链接管理</a></li>
                        <li ><a href="<?php echo U('Footer/partners','','');?>">合作伙伴管理</a></li>
                    </ul>
                </li>-->
                <li class="active"><a href="<?php echo U('Footer/index','','');?>"><i class="icon-align-justify"></i>底部管理</a></li>
                <li>
                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-title">
                                ...
                                <h5>底部模块 - <?php echo ($parent_name); ?> - 超链接列表</h5>
                                <div style="float:right;margin-right:30px">
                                    <a href="<?php echo U('Footer/index','','');?>" ><span class="label">返回</span></a>
                                </div>
                                <div style="float:right;margin-right:20px">
                                    <a href="#addHyperlink" data-toggle="modal" ><span class="label">添加</span></a>
                                </div>
                                <div id="addHyperlink" class="modal hide">
                                ...
                                <div class="modal-body">
                                    <div class="control-group">
                                        <form method="post" action="<?php echo U('Footer/addHyperlink','','');?>"   class="form-horizontal" />
                                            <div class="control-group">
                                                <label class="control-label">超链接名称</label>
                                                <div class="controls">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">超链接URL</label>
                                                <div class="controls">
                            ...
                            <div class="widget-content nopadding">
                                <form action="<?php echo U('Footer/changeHyperlinkSort','','');?>" method="post" class="form-horizontal"/>
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                            ...
                                            <td>
                                                <?php if($vo["status"] == 0): ?><a href="<?php echo U('Footer/changeHyperlinkStatus','id='.$vo['id'],'');?>"   class="btn btn-primary"><i class="icon-eye-open icon-white">
                                                    </i>显示</a>
                                                    <?php else: ?><a href="<?php echo U('Footer/changeHyperlinkStatus','id='.$vo['id'],'');?>"   class="btn btn-info"><i class="icon-eye-open icon-white"></i>隐藏</a><?php endif; ?>
                                ...
                                <div id="edit_Nav<?php echo ($vo["id"]); ?>" class="modal hide">
                                    ...
                                    <div class="modal-body">
                                        <div class="control-group">
                                            <form method="post" action="<?php echo U('Footer/modifyHyperlink','','');?>"   class="form-horizontal"/>
                                                <div class="control-group">
                        ...
                        <!--超链接删除-->
                                                <div id="deleteNav<?php echo ($vo["id"]); ?>" class="modal hide">
                                                        ...
                                                        <div class="modal-footer">
                                                            <form class="form-horizontal" method="post" action="<?php echo U('Footer/deleteHyperlink','','');?>" />
                                                            <input type="hidden" name="id"  value="<?php echo ($vo["id"]); ?>" />
                                                            <input type="submit" value="确定" class="btn btn-primary" />
