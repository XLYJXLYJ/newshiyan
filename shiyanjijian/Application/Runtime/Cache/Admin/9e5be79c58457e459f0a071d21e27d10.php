                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <!--    <td>
                                            ...
                                            <td>
                                                <a href="<?php echo U('Footer/edit_module','id='.$vo['id'],'');?>"   class="btn btn-inverse"><i class="icon-pencil icon-white"></i>管理超链接</a>
                                                <?php if($vo["status"] == 0): ?><a href="<?php echo U('Footer/changeModuleStatus','id='.$vo['id'],'');?>"   class="btn btn-primary"><i class="icon-eye-open icon-white">
                                                    </i>显示</a>
                                                    <?php else: ?><a href="<?php echo U('Footer/changeModuleStatus','id='.$vo['id'],'');?>"   class="btn btn-info"><i class="icon-eye-open icon-white"></i>隐藏</a><?php endif; ?>
                        ...
                        <!--超链接删除-->
                                                <div id="deleteNav<?php echo ($vo["id"]); ?>" class="modal hide">
                                                        ...
                                                        <div class="modal-footer">
                                                            <form class="form-horizontal" method="post" action="<?php echo U('Footer/deleteModule','','');?>" />
                                                            <input type="hidden" name="id"  value="<?php echo ($vo["id"]); ?>" />
                                                            <input type="submit" value="确定" class="btn btn-primary" />
