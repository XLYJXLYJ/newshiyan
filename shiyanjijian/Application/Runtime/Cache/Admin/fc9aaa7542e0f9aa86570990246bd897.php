								...
								<div id="addFatherType" class="modal hide">
									...
									<div class="modal-body">
										<div class="control-group">
											<form class="form-horizontal" method="post" action="<?php echo U('Page/addPage','','');?>"   />
                                    			<div class="control-group">
								...
								<table class="table table-bordered table-striped">
									...
									<tbody>
										...
										<?php if(is_array($list)): foreach($list as $key=>$type): ?><!-- 子类循环 -->
											...
											<td>
											<!-- 操作按钮 -->
											<a href="<?php echo U('Page/edit_page','id='.$type['id'],'');?>"   class="btn"><i class="icon-wrench">
											</i>编辑</a>
											<!--设置分类是否可见的按钮-->
											<?php if($type["status"] == 0): if($type["content"] != null): ?><a href="<?php echo U('Page/setStatus','id='.$type['id'],'');?>" class="btn btn-primary"><i class="icon-eye-open icon-white"></i>显示</a>
													<?php else: ?>
											...
											<?php else: ?>
												<a href="<?php echo U('Page/setStatus','id='.$type['id'],'');?>" class="btn btn-info"><i class="icon-eye-open icon-white">
												</i>隐藏</a><?php endif; ?>
												...
												<!-- 删除弹出框-->
													<div id="deleteAlert<?php echo ($type["id"]); ?>" class="modal hide">
														...
														<div class="modal-footer">
															<form class="form-horizontal" method="post" action="<?php echo U('Page/deletePage','','');?>"  />
