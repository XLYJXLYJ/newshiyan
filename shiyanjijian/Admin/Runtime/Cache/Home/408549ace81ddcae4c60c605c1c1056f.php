...
<script type="text/javascript">
    ...
    <div id="content">
        <div><a href="./CleanAdd.html"><button class="btn btn-default bg_blue01 c_white center mg10">添加</button></a></div>
        <table class="table tc">
            ...
            <?php if(is_array($c_Clean)): foreach($c_Clean as $key=>$c_art): ?><tr>
                <td><?php echo ($c_art["id"]); ?></td>
                <td><?php echo ($c_art["c_title"]); ?></td>
                <td>2016-11-03</td>
                <td><a href="<?php echo U('Clean/CleanEdit',array('id'=>$c_art['id']));?>"><button class="btn btn-default btn-warning">编辑</button></a></td>
                <td><a href="<?php echo U('Clean/CleanDelete',array('id'=>$c_art['id']));?>"><button class="btn btn-default btn-danger">删除</button></a></td>
