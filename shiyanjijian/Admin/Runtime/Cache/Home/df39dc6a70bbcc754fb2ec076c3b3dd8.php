...
<script type="text/javascript">
    ...
    <div id="content">
        <form class="form-horizontal" role="form" action="<?php echo U('Warning/WarningEdit',array('id'=>5));?>" method="post" enctype="multipart/form-data">
            <div class="form-group mgb20 pdt20">
                <label for="name" class="col-sm-2">标题</label>
                <div>
                    <input class="form-control" id="username" placeholder="" name="w_title" required="" type="text" value="<?php echo ($w_Warning["w_title"]); ?>">
                </div>
            </div>
            <div class="form-group mgb20">
                <label for="name" class="col-sm-2">来源</label>
                <div class="col-sm-6">
                    <input class="form-control" id="username" placeholder="" name="w_from" required="" type="text" value="<?php echo ($w_Warning["w_from"]); ?>">
                </div>
            </div>
            <div class="form-group mgb20">
                <label for="name" class="col-sm-2">解读内容</label>
                <div class="col-sm-10">
                    <textarea class="Warning" placeholder="" name="w_text" required=""><?php echo ($w_Warning["w_text"]); ?></textarea> 
                </div>
            </div>
            <div class="form-group mgb20">
                <label for="name" class="col-sm-2">文章缩略图</label>
                <div class="col-sm-6">
                <input  placeholder="" class="form-control" name="w_img"  type="file">
                </div>
                <!-- <img class="left-img" src="../../../<?php echo ($w_Warning["w_img"]); ?>" alt=""> -->
            </div> 
            <input type="hidden" name="id" value="<?php echo ($w_Warning["id"]); ?>">        
            <div class="form-group mgb20">
                <div class="col-sm-10">
