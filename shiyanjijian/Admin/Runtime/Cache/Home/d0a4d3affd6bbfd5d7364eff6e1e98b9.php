    ...
    <div id="content">
        <form class="form-horizontal" role="form" action="<?php echo U('Clean/CleanAdd');?>" method="post" enctype="multipart/form-data">
            <div class="form-group mgb20 pdt20">
                ...
                <div>
                    <input class="form-control" id="username" placeholder="" name="c_title" required="" type="text" value="<?php echo ($edit_Clean["c_title"]); ?>">
                </div>
            </div>
            ...
            <div class="form-group mgb20 pdt20">
                ...
                <div>
                    <input class="form-control" id="username" placeholder="" name="c_title1" required="" type="text" value="<?php echo ($edit_Clean["c_title1"]); ?>">
                </div>
            </div>
            <div class="form-group mgb20">
            ...
            <div class="form-group mgb20 pdt20">
                ...
                <div>
                    <input class="form-control" id="username" placeholder="" name="c_title2" required="" type="text" value="<?php echo ($edit_Clean["c_title2"]); ?>">
                </div>
            </div>
            <div class="form-group mgb20">
            ...
            <div class="form-group mgb20 pdt20">
                ...
                <div>
                    <input class="form-control" id="username" placeholder="" name="c_title3" required="" type="text" value="<?php echo ($edit_Clean["c_title3"]); ?>">
                </div>
            </div>
            <div class="form-group mgb20">
            ...
            <div class="form-group mgb20 pdt20">
                ...
                <div>
                    <input class="form-control" id="username" placeholder="" name="c_title4" required="" type="text" value="<?php echo ($edit_Clean["c_title4"]); ?>">
                </div>
            </div>
            <div class="form-group mgb20">
            ...
            <div class="form-group mgb20 pdt20">
                ...
                <div>
                    <input class="form-control" id="username" placeholder="" name="c_title5" required="" type="text" value="<?php echo ($edit_Clean["c_title5"]); ?>">
                </div>
            </div>
            <div class="form-group mgb20">
            ...
            <div class="form-group mgb20 pdt20">
                ...
                <div>
                    <input class="form-control" id="username" placeholder="" name="c_title6" required="" type="text" value="<?php echo ($edit_Clean["c_title6"]); ?>">
                </div>
            </div>
            <div class="form-group mgb20">
            ...
            <div class="form-group mgb20 pdt20">
                ...
                <div>
                    <input class="form-control" id="username" placeholder="" name="c_title7" required="" type="text" value="<?php echo ($edit_Clean["c_title7"]); ?>">
                </div>
            </div>
            <div class="form-group mgb20">
            ...
            <div class="form-group mgb20 pdt20">
                ...
                <div>
                    <input class="form-control" id="username" placeholder="" name="c_title8" required="" type="text" value="<?php echo ($edit_Clean["c_title8"]); ?>">
                </div>
            </div>
            <div class="form-group mgb20">
            ...
            <div class="form-group mgb20 pdt20">
                ...
                <div>
                    <input class="form-control" id="username" placeholder="" name="c_title9" required="" type="text" value="<?php echo ($edit_Clean["c_title9"]); ?>">
                </div>
            </div>
            <div class="form-group mgb20">
            ...
            <div class="form-group mgb20 pdt20">
                ...
                <div>
                    <input class="form-control" id="username" placeholder="" name="c_title10" required="" type="text" value="<?php echo ($edit_Clean["c_title10"]); ?>">
                </div>
            </div>
            <div class="form-group mgb20">
