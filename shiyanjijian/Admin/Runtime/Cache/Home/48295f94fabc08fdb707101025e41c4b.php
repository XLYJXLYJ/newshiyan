...
<script type="text/javascript">
    ...
    <div id="content">
        <form class="form-horizontal" role="form" action="<?php echo U('Clean/CleanAddDetail');?>" method="post" enctype="multipart/form-data">
            <div class="form-group mgb20 pdt20">
                <label for="name" class="col-sm-2">主题</label>
                <div>
                    <input class="form-control" id="username" placeholder="" name="c_title" type="text" value="<?php echo ($ccc_title); ?>">
                </div>
            </div>
            <div class="form-group mgb20 pdt20">
                <label for="name" class="col-sm-2">题目</label>
                <div>
                    <input class="form-control" id="username" placeholder="" name="cc_title" required="" type="text">
                </div>
            </div>
            <div class="form-group mgb20">
                <label for="name" class="col-sm-2">图</label>
                <div class="col-sm-6">
                <input  placeholder="" class="form-control" name="cc_img"  type="file">
                </div>
            </div>           
            <div class="form-group mgb20">
                <div class="col-sm-10">
